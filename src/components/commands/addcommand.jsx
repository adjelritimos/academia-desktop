    ...
    return (
        <div className="modal fade" id="addcommand" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div className="modal-dialog w-25 modal-dialog-centered">
                <form onSubmit={(e) => {addcommand(e, name, description, demontration, audioURL, props.setCommands, props.setCommandSelected, props.setLoading); cleanForm(); props.setMessage("adicionado o comando") }} className="modal-content">
