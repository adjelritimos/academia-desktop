            ...
            <div className="modal-dialog w-25 modal-dialog-centered">
                <div className="modal-content">
                    ...
                    <div className="modal-footer border-white mt-0 pt-0">
                        <button disabled={isRecording} onClick={() => {editCommand(props.commandId, props.setCommandSelected, name, description, demonstration, audioURL, props.setCommands,  props.setLoading); props.setMessage("o comando está sendo editado")}} type="button" className="btn btn-info text-white w-100 rounded-pill fw-bold" data-bs-dismiss="modal">Salvar</button>
                    </div>
                </div>
            </div>
        </div>
