    ...
    return (
        <div className="modal fade" id="editlemma" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div className="modal-dialog w-25 modal-dialog-centered">
                <form onSubmit={(e) => {editLemma(e, props.lemmaSelected.id, props.setLemmaSelected, question, answer, audioURL, props.setLemmas, props.setLemmasCopy,  props.setLoading); props.setMessage("O lema está sendo editado")}} className="modal-content">
