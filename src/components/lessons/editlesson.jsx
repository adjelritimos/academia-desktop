    ...
    return (
        <div className="modal fade" id="editlesson" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div className="modal-dialog modal-xl modal-dialog-centered">
                <form onSubmit={(e)=> editLesson(e, props.lesson.id, content, body, props.lesson,  props.setLesson, props.setLessons, props.setLessonsCopy, props.moduleId)} className="modal-content">
